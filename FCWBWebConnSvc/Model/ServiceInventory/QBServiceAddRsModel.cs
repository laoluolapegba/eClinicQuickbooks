...
namespace FCQBWebConnAPI.Model.ServiceInventory
{
    ...
    public class QBServiceAddRsModel
    {
        [XmlElementAttribute("QBXMLMsgsRs", IsNullable = false)]
        public QBXMLMsgsRs QBMsgsRs;
        public QBServiceAddRsModel()
        {

        }
        public QBServiceAddRsModel ReadServiceAddRsXml(string strResponseXml)
        {
            // Create an instance of the XmlSerializer class;
            // specify the type of object to be deserialized.
            XmlSerializer serializer = new XmlSerializer(typeof(QBServiceAddRsModel));
            ...
            QBServiceAddRsModel responseObject;
            // Use CustomerAddRsModel Deserialize method to restore the object's state with
            //data from the XML document.
            responseObject = (QBServiceAddRsModel)serializer.Deserialize(sr);
        ...
        public class QBXMLMsgsRs
        {
            ...
            [XmlElementAttribute("ItemServiceAddRs", IsNullable = false)]
            public ServiceInventoryAddRs ServiceAddRs;
            public QBXMLMsgsRs()
            {
        ...
        public class ServiceInventoryAddRs
        {
            [XmlElementAttribute("ItemServiceRet", IsNullable = false)]
            public ServiceAddRetModel ItemAdd;
        ...
        public class ServiceAddRetModel
        {
